...
<head>
  ...
  <?php 
		$this->load->view('include/heat-detail2');
   ?> 
    ...
    <div class="top-header">
        <div class="container">
            <div class="nav-top-links">
                <a class="first-item" href="#"><img alt="phone" src="<?php echo base_url(); ?>public/assets/data/phone.png" />00-62-658-658</a>
                <a href="#"><img alt="email" src="<?php echo base_url(); ?>public/assets/data/email.png" />Contact us today!</a>
            </div>
            <div class="currency ">
                <div class="dropdown">
            ...
            <div class="language ">
                <div class="dropdown">
                      ...
                      <img alt="email" src="<?php echo base_url(); ?>public/assets/data/fr.jpg" />French
                      </a>
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="#"><img alt="email" src="<?php echo base_url(); ?>public/assets/data/en.jpg" />English</a></li>
                        <li><a href="#"><img alt="email" src="<?php echo base_url(); ?>public/assets/data/fr.jpg" />French</a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container main-header">
        <div class="row">
            <div class="col-xs-12 col-sm-3 logo">
                <a href="index.html"><img alt="Kute shop - themelock.com" src="<?php echo base_url(); ?>public/assets/data/logo.png" /></a>
            </div>
                            ...
                            <ul>
                                <li class="product-info">
                                    <div class="p-left">
                                        ...
                                        <a href="#">
                                        <img class="img-responsive" src="<?php echo base_url(); ?>public/assets/data/product-100x122.jpg" alt="p10">
                                        </a>
                                    </div>
                                    <div class="p-right">
                                ...
                                <li class="product-info">
                                    <div class="p-left">
                                        <a href="#" class="remove_link"></a>
                                        <a href="#">
                                        <img class="img-responsive" src="<?php echo base_url(); ?>public/assets/data/product-s5-100x122.jpg" alt="p10">
                                        </a>
                                    </div>
                                    <div class="p-right">
                                        <p class="p-name">Donec Ac Tempus</p>
                ...
                <div class="col-sm-3" id="box-vertical-megamenus">
                    ...
                    <div class="vertical-menu-content is-home">
                        <ul class="vertical-menu-list">
                            <li><a href="#"><img class="icon-menu" alt="Funky roots" src="<?php echo base_url(); ?>public/assets/data/1.png">Electronics</a></li>
                            <li>
                                <a class="parent" href="#"><img class="icon-menu" alt="Funky roots" src="<?php echo base_url(); ?>public/assets/data/2.png">Sports &amp; Outdoors</a>
                                <div class="vertical-dropdown-menu">
                                    <div class="vertical-groups col-sm-12">
                                        ...
                                        <div class="mega-custom-html col-sm-12">
                                            <a href="#"><img src="<?php echo base_url(); ?>public/assets/data/banner-megamenu.jpg" alt="Banner"></a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li><a href="#"><img class="icon-menu" alt="Funky roots" src="<?php echo base_url(); ?>public/assets/data/3.png">Smartphone &amp; Tablets</a></li>
                            <li><a href="#"><img class="icon-menu" alt="Funky roots" src="<?php echo base_url(); ?>public/assets/data/4.png">Health &amp; Beauty Bags</a></li>
                            <li>
                                <a class="parent" href="#">
                                <img class="icon-menu" alt="Funky roots" src="<?php echo base_url(); ?>public/assets/data/5.png">Shoes &amp; Accessories</a>
                                <div class="vertical-dropdown-menu">
                                        <div class="vertical-groups col-sm-12">
                                                ...
                                                <div class="row mega-products">
                                                    <div class="col-sm-3 mega-product">
                                                        <div class="product-avatar">
                                                            <a href="#"><img src="<?php echo base_url(); ?>public/assets/data/p10.jpg" alt="product1"></a>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-3 mega-product">
                                                        <div class="product-avatar">
                                                            <a href="#"><img src="<?php echo base_url(); ?>public/assets/data/p11.jpg" alt="product1"></a>
                                                        </div>
                                                        <div class="product-name">
                                                            <a href="#">Fashion hand bag</a>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-3 mega-product">
                                                        <div class="product-avatar">
                                                            <a href="#"><img src="<?php echo base_url(); ?>public/assets/data/p12.jpg" alt="product1"></a>
                                                        </div>
                                                        <div class="product-name">
                                                            <a href="#">Fashion hand bag</a>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-3 mega-product">
                                                        <div class="product-avatar">
                                                            <a href="#"><img src="<?php echo base_url(); ?>public/assets/data/p13.jpg" alt="product1"></a>
                                                        </div>
                                                        <div class="product-name">
                                                            <a href="#">Fashion hand bag</a>
                                                        </div>
                            ...
                            <li><a href="#"><img class="icon-menu" alt="Funky roots" src="<?php echo base_url(); ?>public/assets/data/6.png">Toys &amp; Hobbies</a></li>
                            <li><a href="#"><img class="icon-menu" alt="Funky roots" src="<?php echo base_url(); ?>public/assets/data/7.png">Computers &amp; Networking</a></li>
                            <li><a href="#"><img class="icon-menu" alt="Funky roots" src="<?php echo base_url(); ?>public/assets/data/8.png">Laptops &amp; Accessories</a></li>
                            <li><a href="#"><img class="icon-menu" alt="Funky roots" src="<?php echo base_url(); ?>public/assets/data/9.png">Jewelry &amp; Watches</a></li>
                            <li><a href="#"><img class="icon-menu" alt="Funky roots" src="<?php echo base_url(); ?>public/assets/data/10.png">Flashlights &amp; Lamps</a></li>
                            <li>
                                <a href="#">
                                    <img class="icon-menu" alt="Funky roots" src="<?php echo base_url(); ?>public/assets/data/11.png">
                                    Cameras &amp; Photo
                                </a>
                            </li>
                            <li class="cat-link-orther">
                                <a href="#">
                                    <img class="icon-menu" alt="Funky roots" src="<?php echo base_url(); ?>public/assets/data/5.png">
                                    Television
                                </a>
                            </li>
                            <li class="cat-link-orther">
                                <a href="#">
                                    <img class="icon-menu" alt="Funky roots" src="<?php echo base_url(); ?>public/assets/data/7.png">Computers &amp; Networking
                                </a>
                            </li>
                            <li class="cat-link-orther">
                                <a href="#">
                                    <img class="icon-menu" alt="Funky roots" src="<?php echo base_url(); ?>public/assets/data/6.png">
                                    Toys &amp; Hobbies
                                </a>
                            </li>
                            <li class="cat-link-orther">
                            <a href="#"><img class="icon-menu" alt="Funky roots" src="<?php echo base_url(); ?>public/assets/data/9.png">Jewelry &amp; Watches</a></li>
                        </ul>
                                            ...
                                            <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <a href="#">
                                                            <img class="img-responsive" src="<?php echo base_url(); ?>public/assets/data/men.png" alt="sport">
                                                        </a>
                                                    </li>
                                             ...
                                             <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <a href="#">
                                                            <img class="img-responsive" src="<?php echo base_url(); ?>public/assets/data/women.png" alt="sport">
                                                        </a>
                                                    </li>
                                                    <li class="link_container group_header">
                                                        <a href="#">WOMEN'S</a>
                                             ...
                                             <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <a href="#">
                                                            <img class="img-responsive" src="<?php echo base_url(); ?>public/assets/data/kid.png" alt="sport">
                                                        </a>
                                                    </li>
                                                    <li class="link_container group_header">
                                                        <a href="#">Kids</a>
                                             ...
                                             <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <a href="#">
                                                            <img class="img-responsive" src="<?php echo base_url(); ?>public/assets/data/trending.png" alt="sport">
                                                        </a>
                                                    </li>
                                                    <li class="link_container group_header">
                                                        <a href="#">TRENDING</a>
                                    ...
                                    <li class="dropdown">
                                        <a href="category.html" class="dropdown-toggle" data-toggle="dropdown">Foods</a>
                                            ...
                                            <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <img src="<?php echo base_url(); ?>public/assets/data/banner-topmenu.jpg" alt="Banner">
                                                    </li>
                                                </ul>
                                            </li>
                            ...
                            <div class="pb-left-column col-xs-12 col-sm-5">
                                ...
                                <div class="product-image">
                                    <div class="product-full">
                                        <img id="product-zoom" src='<?php echo base_url(); ?>public/assets/data/product-s3-420x512.jpg' data-zoom-image="<?php echo base_url(); ?>public/assets/data/product-s3-850x1036.jpg"/>
                                    </div>
                                    <div class="product-img-thumb" id="gallery_01">
                                        <ul class="owl-carousel" data-items="3" data-nav="true" data-dots="false" data-margin="21" data-loop="true">
                                            <li>
                                                <a href="#" data-image="<?php echo base_url(); ?>public/assets/data/product-s3-420x512.jpg" data-zoom-image="<?php echo base_url(); ?>public/assets/data/product-s3-850x1036.jpg">
                                                    <img id="product-zoom"  src="<?php echo base_url(); ?>public/assets/data/product-s3-100x122.jpg" /> 
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="<?php echo base_url(); ?>public/assets/data/product-s2-420x512.jpg" data-zoom-image="<?php echo base_url(); ?>public/assets/data/product-s2-850x1036.jpg">
                                                    <img id="product-zoom"  src="<?php echo base_url(); ?>public/assets/data/product-s2-100x122.jpg" /> 
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="<?php echo base_url(); ?>public/assets/data/product-420x512.jpg" data-zoom-image="<?php echo base_url(); ?>public/assets/data/product-850x1036.jpg">
                                                    <img id="product-zoom"  src="<?php echo base_url(); ?>public/assets/data/product-100x122.jpg" /> 
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="<?php echo base_url(); ?>public/assets/data/product-s4-420x512.jpg" data-zoom-image="<?php echo base_url(); ?>public/assets/data/product-s4-850x1036.jpg">
                                                    <img id="product-zoom"  src="<?php echo base_url(); ?>public/assets/data/product-s4-100x122.jpg" /> 
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="<?php echo base_url(); ?>public/assets/data/product-s5-420x512.jpg" data-zoom-image="<?php echo base_url(); ?>public/assets/data/product-s5-850x1036.jpg">
                                                    <img id="product-zoom"  src="<?php echo base_url(); ?>public/assets/data/product-s5-100x122.jpg" /> 
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-image="<?php echo base_url(); ?>public/assets/data/product-s6-420x512.jpg" data-zoom-image="<?php echo base_url(); ?>public/assets/data/product-s6-850x1036.jpg">
                                                    <img id="product-zoom"  src="<?php echo base_url(); ?>public/assets/data/product-s6-100x122.jpg" /> 
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
